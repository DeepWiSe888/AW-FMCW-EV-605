...
num_range_bins = round(num_range_nfft / 2);
...
% save('./libs/conf.mat','c','sample_rate_Hz','chirp_time','num_rx','num_tx','min_RF_frequency_Hz','max_FR_frequency_Hz',...
%     'B','S','d_max','num_samples_per_chirp','num_chirps_per_frame',...
%     'fps','num_range_nfft','num_range_bins','num_doppler_nfft');
